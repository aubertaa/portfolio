  ...
  getCompetencies () {
    ...
    return [
      ...
      },
      {
        ...
        level: 3,
        description: 'Le suivi des coûts de l\'activité de développement de logiciels est une discipline assez nouvelle mais essentielle : je suis très impliqué sur le suivi des coûts dans le cloud (AWS), leur optimisation et le dashboarding qui sert à piloter ces coûts.\n\nCela permet de garantir la pérennité de l\'activité, de réduire les coûts inutiles et de garantir la rentabilité des projets.\n\nC\'est un aspect très important de la gestion de projet et de l\'activité de l\'entreprise, qui doit être pris en compte dès le début du projet.',
        certification: ''
      },
      {
        ...
        level: 4,
        description: "J'ai organisé, à plusieurs reprise et dans des contextes internationaux divers, la mise en place de tests transverses (inter-équipes, inter-sites), le déploiement de nouveaux outils (VCS, Sonarqube, Dependency Track par ex.).\n\nJ'ai aussi piloté des projets de refonte de processus (SDLC), de mise en place de nouvelles pratiques, pour la mise en conformité à l'ISO27001 par exemple.\n\nJ'ai pu démontrer ma capacité à mener à bien des projets de bout en bout, en respectant les équipes, les délais, les coûts et la qualité attendue.",
        certification: ''
      },
      {
        title: 'ISO 27001',
        ...
        logo: 'logos/iso.png',
        level: 4,
        description: 'Je suis en charge de la mise en place initiale et du suivi de la conformité ISO 27001 du processus de développement / livraison de l\'entreprise : 4-eyes principle, moindre privilège, revues de code croisées et analyses statiques de code (SAST).\n\nJe participe à l\'audit annuel de renouvellement de la certification de l\'entreprise et suis officiellement porteur de certains risques (et des actions de mitigation) liés à notre cycle de développement, parmi lesquels : les risques de non conformité lors du processus de développement, le respect des pratiques collectives pendant les périodes de congés ou d\'absence.',
        certification: ''
      },
      {
        title: 'Management',
        ...
        level: 4,
        description: "Je suis actuellement manager de 22 personnes (3 testeur.se.s, 1 profil CI/DevOps, 4 profils Infra/DevOps, 13 développeur.se.s, 1 Product Owner).\n\nSelon moi, la mission principale d'un manager est de garantir le bien-être de ses collaborateurs, de les aider à progresser et à s'inscrire dans une dynamique d'amélioration continue.\n\nSi parfois cela peut passer par des décisions et actions difficiles ou délicates, je pense qu'il est important de toujours garder à l'esprit l'intérêt de l'équipe et de l'entreprise.\n\nJ'ai pu démontrer mes capacités de management dans mes différentes missions, où j'ai toujours été reconnu pour ma capacité à fédérer les équipes, à les motiver et à les accompagner dans leur progression.",
        certification: ''
      },
      {
        ...
        level: 5,
        description: 'Je suis totalement opérationnel sur la définition et l\'implémentation d\'une politique de test, d\'une stratégie de test dans l\'entreprise de développement logiciel.\n\nC\'est important pour une bonne gestion des risques et des investissements en test, dépendant des contraintes et du contexte de l\'entreprise.\n\nLorsque je me suis présenté chez AT Internet en 2015, j\'ai procédé à un état des lieux et ai proposé un plan d\'action court/moyen/long terme pour améliorer la qualité des livrables et la satisfaction des clients.\n\nCe plan a été validé et mis en place progressivement, avec des résultats très positifs pour l\'entreprise et les équipes de développement.\n\nCertains aspects de ce plan sont toujours en cours de mise en place et d\'amélioration, et je continue à les suivre et à les faire évoluer en fonction des retours et des évolutions des équipes.',
      ...
      },
      {
        ...
        logo: 'logos/rgpd.png',
        level: 5,
        description: 'Je supervise le respect du cadre règlementaire en vigueur : de la protection des données personnelles dans le cadre de la solution implémentée (données client / intégrité / complétude / rétention / consentement éclairé / finalités) au cadre de la vie de l\'entreprise (données "employés").\n\nMes implémentations d\'envoi de données "maison" pour les activités de test et de développement de nos produits nous permettent de rester en complète conformité avec le RGPD.',
        certification: ''
      },
      {
        title: 'Scrum master',
      ...
      },
      {
        ...
        level: 4,
        description: 'J\'ai procédé au développement d\'interfaces dans le cadre scolaire (Project Management Tool, Innotech Votes, Portfolio personnel).\n\nJ\'ai obtenu, sur ces créations, des retours très positifs.',
        certification: ''
      },
      {
        ...
        level: 4,
        description: 'J\'ai procédé au développement et à la maintenance de backends dans le cadre scolaire (Project Management Tool, Innotech Votes, Games Up).\n\nJ\'ai obtenu, sur ces créations, des retours très positifs.',
        certification: ''
      },
      {
        title: 'NodeJS',
        ...
        level: 4,
        description: 'J\'ai développé des mécaniques avancées de tests automatisés d\'API en nodeJS mais également un projet d\'extraction et de suivi des dépendances d\'autres projets NodeJS.\n\nMes développements ont intégré les pratiques de tests unitaires et les déclenchements d\'analyse statique de code.',
        certification: ''
      },
      {
        title: 'Python',
        ...
        level: 4,
        description: 'Je développe et maintiens différents outillages "backoffice" (alerting, monitoring, tâches de maintenance).\n\nJe développe également un projet de génération de données maison (hit-maker), en y incluant les pratiques de tests unitaires et d\'intégration',
        certification: ''
      },
      {
        title: 'QuasarJS',
        ...
        level: 4,
        description: 'Lors de la refonte du site web MaCaveAMoi en 2023 (anciennement sous joomla/PHP) j\'ai décidé de découvrir et d\'implémenter la nouvelle version en QuasarJS, un framework basé sur VueJS que je ne connaissais pas.\n\nJ\'assure aussi l\'administration de ce site et la livraison des évolutions, incluant l\'application mobile disponible sur Android.',
        certification: ''
      },
      {
        title: 'Shell',
      ...
      },
      {
        ...
        level: 5,
        description: "Indispensable pour une bonne communication et la prise en compte du cadre propre de notre interlocuteur, l'assertivité est une notion très importante pour moi.\n\nIl est en effet essentiel de savoir respecter l'autre tout en se respectant soi-même dans l'échange.\n\nEn tant que manager et porteur d'éléments stratégiques pour l'entreprise, cela est très utile pour se retrouver rapidement avec mes collaborateurs sur un terrain constructif et efficace.\n\nPlusieurs formations et lectures m'ont permis de développer mes connaissances à ce sujet et d'acquérir certains outils pour l'appliquer au quotidien (CNV, PNL, Process Communication par ex.).",
        certification: ''
      },
      {
        title: 'Autonomie',
      ...
      },
      {
        ...
        level: 5,
        description: "J'aime la proactivité, faire des propositions, envisager des solutions et penser à des actions disruptives, pour faire avancer l'entreprise et les projets.\n\nJe me méfie des habitudes, des 'on a toujours fait comme ça' car je pense qu'il est important de se renouveller sans cesse, de s'appuyer sur les acquis pour aller plus loin.\n\nJe sais pour autant rester pragmatique dans mes choix, en tenant compte des risques et des contraintes, pour ne pas me lancer dans des aventures sans issue.",
        certification: ''
      },
      {
        title: 'Polyvalence',
        ...
        level: 5,
        description: "Je suis multitâche : par mon expérience, je suis aujourd'hui opérationnel sur beaucoup de choses différentes, tant techniques qu'organisationnelles mais je sais aussi apprendre et découvrir de nouvelles choses.\n\nJ'aime la variété, la diversité des tâches et des missions, cela me permet de rester motivé et de ne pas m'ennuyer.\n\nIl est important pour moi de ne jamais refuser un nouveau défi qui se présente, pour continuer à progresser et à apprendre.",
        certification: ''
      },
      {
        title: 'Rigueur',
        ...
        level: 5,
        description: 'Je suis rigoureux dans mon travail, j\'aime que les choses soient bien faites, dans les règles de l\'art.\n\nCela me permet de garantir la qualité de mon travail, de respecter les délais et les engagements pris, de ne pas laisser de place à l\'imprévu.\n\nJe suis très attaché à la qualité de mon travail, et je m\'efforce de toujours donner le meilleur de moi-même.\n\nCela m\'a permis de gagner la confiance de mes collègues et de mes supérieurs, qui savent qu\'ils peuvent compter sur moi pour mener à bien les missions qui me sont confiées.',
        certification: ''
      },
      {
        title: 'S.S.T.',
        ...
        logo: 'logos/SST.png',
        level: 5,
        description: 'Sauveteur Secouriste du Travail : formation aux premiers secours en entreprise.\n\nJe n\'ai pas hésité à me porter volontaire pour suivre cette formation, car je pense qu\'il est important de savoir réagir en cas d\'urgence, pour soi-même, pour ses collègues, pour ses proches.\n\nCela m\'a permis d\'apprendre les premiers gestes en matière de secourisme, et de pouvoir intervenir efficacement en cas d\'accident ou de malaise en entreprise.',
      ...
      },
      {
        ...
        logo: 'logos/aws.png',
        level: 5,
        description: "J'ai une utilisation professionnelle quotidienne des services AWS : infra as code (Cloudformation), messaging (SQS/SNS), aspects réseau et sécurité (VPC, IAM, Security Groups), stockage (S3, EBS), compute (EC2, Lambda), gestion des coûts (Cost Explorer, Budgets).\n\nJ'accompagne également les équipes sur leur usage de ces services.",
