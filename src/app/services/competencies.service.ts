  ...
  getCompetencies () {
    ...
    return [
      ...
      },
      {
        ...
        level: 5,
        description: "L'autonomie est la capacité à mener seul une mission qui nous est confiée, voire même à définir soi même ses objectifs, une fois le cap ou la vision déclinée. Etre autonome ne signifie pas forcément travailler seul.\n\nJe pense en effet que l'autonomie, c'est aussi demander de l'aide quand on a besoin, pour avancer et progresser efficacement.",
