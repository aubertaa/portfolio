  ...
  getProjects () {
    ...
    return [
      ...
      },
      {
        ...
        description: 'API de recommandation de jeux vidéos basée sur des données de jeux vidéos et des avis utilisateurs.\n\nL\'API est déployée dans un conteneur Docker et est accessible via une interface REST. Elle permet de recommander des jeux vidéos en fonction de critères de recherche (genre, plateforme, prix, etc.). L\'algorithme de recommandation est du type KNN (K-Nearest Neighbors).'
      },
      {
        title: 'GamesUp',
        date: '2024',
      ...
      },
      {
        ...
        description: "MaCaveAMoi est un logiciel de gestion de cave en ligne : disponible sur le web, mobile (Android Play Store) et sur Alexa (assistant vocal Amazon). Il permet de gérer sa cave à vin, de suivre ses dégustations, de partager ses découvertes et de découvrir de nouveaux vins.\n\nLes outils proposés sont simples et répondent aux besoins des amateurs de vin. Le Front est codé en QuasarJS, le Back en NodeJS/PHP, et l'API Alexa en NodeJS."
      },
      {
        ...
        description: "Définition d'objectifs clairs de mise en place de l'intégration continue dans les équipes de développement. Définition des pratiques et des outils à mettre en place : build/TU automatisés, déploiement automatisé, tests de no non régression, mécaniques de promotion des livrables.\n\nSuivi et accompagnement des équipes pour la mise en place effective. Diffusion d'une culture DevOps et d'une culture de l'amélioration continue."
      },
      {
        ...
        documents: [],
        description: "Mise en place de tests de non régression sur une API avec des remontées de bugs déjà importantes : fiabilisation des développements et des évolutions, correction et amélioration de l'existant.\n\nDéfinition des données de test, validation des données brutes et des données agrégées, suivi des anomalies et des corrections. Priorisation des actions correctives et des implémentations en fonction des priorités d'usage client."
      },
      {
        ...
        description: 'Proposition, définition et mise en place d\'une politique de test d\'entreprise ou "Comment combiner pratiques de test et Agilité".\n\nDéfinition et implémentation progressive d\'une double stratégie de tests : anticipative pour éviter de nouvelles régressions en production et réactive pour gérer au mieux les régressions déjà présentes en production.'
      },
      {
        ...
        documents: [],
        description: "Mise en place en autonomie d'une mécanique de non régression automatisée pour valider des fonctionnalités d'un client lourd (Excel) et d'un Add-In Excel.\n\nAutomatisation des tests de calculs statistiques, interactions graphiques avec Sikuli, un outil de reconnaissance d'images. Définition des jeux de données, validation des résultats mathématiques et graphiques sur différentes versions d'Office et différents versions d'OS (Windows, Mac)."
      },
      {
        ...
        documents: [],
        description: "Implémentation de tests de non régression pour un backend de stockage de données dans le cloud. Suivi, alimentation de la roadmap et recette des versions de l'outil de test (Galathee) développé sur mesure.\n\nEnviron 100 000 cas de tests implémentés seul, parallélisation des exécutions et suivi des référentiels de données."
      }
    ];
